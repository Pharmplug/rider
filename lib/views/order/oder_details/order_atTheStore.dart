...
class OrdersAtTheStore extends StatefulWidget {
  final List<OrderItem> item;

  const OrdersAtTheStore({
    Key? key,
    required this.item,
  }) : super(
          key: key,
...
class _OrderState extends State<OrdersAtTheStore> {
  late int index = 0;
              ...
              Row(
                children: [
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => OrdersToPickup(item: []), // Pass your item here
                    ),
                  );
                  },
                    child: Image.asset(
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => OrdersOnTransit(
                                    item: []), // Pass your item here
                              ),
                            );
                          },
                          child: Image.asset(
                            AppImages.storefront,
                            scale: 5,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TrackerIcons(
                        ...
                        getSize: _getSize,
                        icon: Image.asset(AppImages.store,
                            color: Pallete.whiteColor),
                        containerColor: Pallete.primaryColor),
                    DottedLine(
                      direction: Axis.horizontal,
                    ...
                    DottedLine(
                      ...
                      lineThickness: 1.0,
                      dashLength: 4.0,
                      dashColor: Pallete.disabledColor,
                      dashRadius: 0.0,
                      dashGapLength: 4.0,
                      dashGapColor: Colors.transparent,
                      dashGapRadius: 0.0,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          OrdersOnTransit(item: []), // Pass your item here
                    ),
                  );
                },
                child: Container(
