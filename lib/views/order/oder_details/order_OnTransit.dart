...
class OrdersOnTransit extends StatefulWidget {
  final List<OrderItem> item;

  const OrdersOnTransit({
    Key? key,
    required this.item,
  }) : super(
          key: key,
...
class _OrderState extends State<OrdersOnTransit> {
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          OrdersAtDropOff(item: []), // Pass your item here
                    ),
                  );
                },
                child: Container(
