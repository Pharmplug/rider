...
class _OrderState extends State<OrdersAccepted> {
                ...
                children: [
                  GestureDetector(
                     onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => OrderDetailsScreen(items: [],)));
                    },
                    child: Image.asset(
                      AppImages.back,
                      scale: 2,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        border: Border.all(color: Pallete.hintText, width: 1),
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          OrdersToPickup(item: []), // Pass your item here
                    ),
                  );
                },
